              ...
              <div className="my-5 flex flex-col gap-5">
                {questions[index].options.map((a, i) => (
                  <button
                    ...
                    key={i}
                    className="h-10 w-full border flex items-center ps-5 rounded-lg cursor-pointer hover:bg-green-300 hover:text-white focus:bg-orange-600 focus:text-white outline-none"
                  >
                    {i + 1}. {a}
                  </button>
                ))}
